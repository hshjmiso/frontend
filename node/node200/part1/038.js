...
console.log('toLocaleString : %s', date.toLocaleString());
console.log('toLocaleDateString : %s', date.toLocaleDateString());
console.log('toLocaleTimeString : %s', date.toLocaleTimeString());
